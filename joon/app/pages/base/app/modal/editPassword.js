      ...
      >
        <div className="modalcontent">
          <Form layout="horizontal" autoComplete="off">
            <Row>
              <Col span="24">
                <FormItem {...formItemLayout} label="기존 비밀번호">
                  {getFieldDecorator('oldPwd', {
                    rules: [
                      { required: true, message: '비밀번호를 입력하세요！' },
                      { pattern: regExpConfig.pwd, message: '비밀번호는 6-16글자 입니다!' },
            ...
            <Row>
              <Col span="24">
                <FormItem {...formItemLayout} label="새로운비밀번호">
            ...
            <Row>
              <Col span="24">
                <FormItem {...formItemLayout} label="새로운비밀번호 확인">
